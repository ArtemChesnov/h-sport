...
В каталоге [docs/](docs/README.md): деплой, архитектура, локальная разработка, API, интеграции, операции, [инструкция по админке для клиента](docs/ADMIN_USER_GUIDE.md). Чек-лист перед продом: [PRE_PROD_CHECKLIST.md](PRE_PROD_CHECKLIST.md).
