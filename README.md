...
В каталоге [docs/](docs/README.md): [деплой на VPS](docs/DEPLOYMENT.md), архитектура, локальная разработка, API, интеграции, [инструкция по админке для клиента](docs/ADMIN_USER_GUIDE.md).
...
- Внутренние отчёты и чек-листы добавлены в `.gitignore`
