...
export function useCatalogFilters(applyImmediately = true) {
  ...
  const [pendingPriceFrom, setPendingPriceFrom] = React.useState<number | undefined>(defaultPriceFrom);
  ...
  // Стабильные ключи для зависимостей useEffect
  ...
  const updateFilters = React.useCallback(
    (
      ...
      React.startTransition(() => {
        ...
        const categories =
          updates.categorySlug !== undefined
            ? updates.categorySlug
            : urlCategories;
        const sizes = updates.size !== undefined ? updates.size : urlSizes;
        const priceFrom =
          updates.priceFrom !== undefined ? updates.priceFrom : currentPriceFrom;
        const priceTo =
          updates.priceTo !== undefined ? updates.priceTo : currentPriceTo;
  ...
  const setPendingPrice = React.useCallback(
