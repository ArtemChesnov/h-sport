...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm opacity-70 group ...">
          <CloseLogo alt="close" className="w-10 h-10 cursor-pointer stroke-[#EB6081] group-hover:stroke-black transition-colors" />
