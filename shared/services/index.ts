...
export { addFavorite, fetchFavorites, removeFavorite } from "./api/shop/favorites/favorites.service";
...
export { fetchAdminOrder, fetchAdminOrders, updateAdminOrder } from "./api/admin/admin.orders.service";
...
export { fetchAdminUser, fetchAdminUsers, updateAdminUserRole } from "./api/admin/admin.users.service";
