  ...
  return (
    <section className="space-y-6 text-sm">
      <div className="text-center space-y-4">
        <div ref={iconRef} className="mx-auto w-16 h-16 rounded-full bg-green-100 flex items-center justify-center motion-reduce:opacity-100">
          <svg
        ...
        <h1 ref={titleRef} className="text-2xl font-semibold motion-reduce:opacity-100">Спасибо за ваш заказ!</h1>
        <p ref={descRef} className="text-neutral-600 max-w-md mx-auto motion-reduce:opacity-100">
          Ваш заказ успешно оплачен. Мы отправили письмо с деталями заказа на ваш e-mail.
      ...
      <div className="flex flex-col sm:flex-row gap-3 pt-4">
        <Link href="/account/orders" className="flex-1">
          <DesignButton variant="default" className="w-full h-14 rounded-[10px] border-0 text-base">Перейти в личный кабинет</DesignButton>
        </Link>
        <Link href="/catalog" className="flex-1">
          <DesignButton variant="outline" className="w-full h-14 rounded-[10px] border-neutral-300 text-base">
      ...
      <div className="text-center text-xs text-neutral-500 pt-4">
        <p>
          Если у вас возникли вопросы, свяжитесь с нами по email или телефону.
        </p>
      </div>
    </section>
  );
