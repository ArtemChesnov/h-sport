...
export default function AdminOrdersLoading() {
  return (
    <div className="flex-1 space-y-4 md:space-y-6 p-3 pt-4 md:p-4 md:pt-6 lg:p-8">
      ...
      {/* Фильтры */}
      <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-white via-white to-indigo-50/20 p-4">
      ...
      {/* Таблица заказов */}
      <div className="rounded-2xl border border-border/50 bg-gradient-to-br from-white via-white to-indigo-50/20 shadow-sm">
