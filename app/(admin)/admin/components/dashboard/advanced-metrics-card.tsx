    ...
    >
      <TooltipProvider>
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Категории, товары, пользователи, доставка и оплата</p>
        </div>
      ...
      <MetricsSection
        title="Пользователи"
        description="Аналитика по клиентам и их активности"
      >
          ...
          <p className="text-xs text-muted-foreground mt-3">
            Детальная аналитика по клиентам (LTV, VIP клиенты) доступна в блоке &quot;Бизнес-аналитика&quot; ниже
          </p>
        </MetricsSection>
