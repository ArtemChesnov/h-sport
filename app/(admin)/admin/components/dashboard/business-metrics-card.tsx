          ...
          <MetricsSection title="Брошенные корзины">
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <MetricCard
                ...
                description="Пиковый час за период (МСК)"
                tooltipTitle="Пиковый час за период"
                tooltipContent="Час по МСК, в который за выбранный период (7/30/90 дней) было заброшено больше всего корзин — не среднее время и не «сейчас». Одна новая корзина не изменит топ, если за период в другом часу бросили больше. Данные кешируются на 5 мин."
                color="blue"
              />
            </div>
          </MetricsSection>
