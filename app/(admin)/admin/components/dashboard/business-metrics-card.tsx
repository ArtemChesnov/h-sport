          ...
          <MetricsSection title="Брошенные корзины">
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
              ...
              <MetricCard
                ...
                description="Больше всего брошенных корзин (МСК)"
                tooltipTitle="Час с максимальным количеством брошенных корзин"
                tooltipContent="Час суток по московскому времени (МСК), в который было заброшено больше всего корзин. Помогает определить оптимальное время для отправки напоминаний или промо-акций."
                color="blue"
              />
            </div>
          </MetricsSection>
